...
export interface RunSummary { id: string; projectId: string; projectName: string | null; ticketId: string; appUrl: string; slug: string | null; status: RunStatus; passCount: number; failCount: number; blockedCount: number; untestedCount: number; cancelledCount: number; totalAcs: number; createdAt: string; finishedAt: string | null }
